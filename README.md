...
Using `image()` in the content schema, and any SVG image in the frontmatter, seems to trigger it. See the comment in `content/articles/article-2.mdx`'s frontmatter.
...
See the comment in `content/articles/article-2.mdx`'s frontmatter:
